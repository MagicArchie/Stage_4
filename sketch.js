...
function preload() {
  ...
  for (let i = 1; i <= 7; i++) {
    images.push(loadImage("materials/levels/Lvl_B" + i + ".4.jpg"));
...
function setup() {
  ...
  keyimg = createImg("materials/keys/Key_D1.3.png", "key-img");
...
function artistInfo() {
  ...
  window.open("https://www.nationalgallery.gr/artist/argyros-oumvertos/", "_blank");
}